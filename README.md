...
1. Add the package via git url ``https://github.com/kandreyc/unity-csharp-patch.git#v1.7.0`` or download latest package from [releases](https://github.com/kandreyc/unity-csharp-patch/tags)
